...
class FontColors {
  ...
  late FontColor h2 = FontColor(color: const Color(0xff979797), style: style);
  late FontColor black2b = FontColor(color: AppColors.black2b, style: style);
  late FontColor gray94 = FontColor(color: AppColors.gray94, style: style);
  ...
  late FontColor black31 = FontColor(color: AppColors.black31, style: style);
